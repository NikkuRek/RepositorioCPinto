...
/*----------------------------------------------Formulario----------------------------------------------*/
	...
	if(isset($_POST['guardar'])){
		...
		if ($result == 1){
			...
			header('Location: ../controlador/proveedor_controlador.php?exito=true');
			exit();
			
		} else {
			
			/*header('Location: ../controlador/proveedorForm_controlador.php?exito=false');*/
			header('Location: ../controlador/proveedor_controlador.php?exito=false');
			exit();
	...
	if (isset($_GET['id'])){
		...
		if ($objventa->buscar()){
			...
			echo "<script>
				...
				location.href='proveedor_controlador.php';
			</script>";
		}			   
	}
	...
	if (isset($_POST['Volver'])) {
		echo "<script>location.href='proveedor_controlador.php'</script>";
	}
