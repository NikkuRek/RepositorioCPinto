...
if( !isset($_SESSION['id_usuario']) ){
  echo "<script>
    ...
    <ul class="menu">
        ...
        <li><img src="../vista/img/arrows-repeat.png" alt="Transacciones"><a href="../controlador/transacciones_controlador.php"><b>Pedidos</b></a></li>
        <li><img src="../vista/img/box-open.png" alt="Proveedores"><a href="../controlador/proveedor_controlador.php"><b>Ventas</b></a></li>
        ...
        <li><img src="../vista/img/box-open.png" alt="Productos"><a href="../controlador/producto_controlador.php"><b>Elementos</b></a></li>
