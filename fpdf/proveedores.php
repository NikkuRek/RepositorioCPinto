...
function Header()
{
    ...
    $this->Cell(1,10,utf8_decode('Lista de Proveedores'),0,1,'C',0);
    $this->Ln(20);
}
...
// Llamada al modelo para obtener datos de Proveedores
$reporte = new ReportesModelo();
$Proveedores = $reporte->obtenerDatosProveedores();
...
$pdf->Cell(45,10,utf8_decode('CORREO'),1,1,'C',1);
...
for($i=0;$i<count($Proveedores);$i++){
    ...
    $pdf->Cell(10,10,$Proveedores[$i]['id_proveedor'],1,0,'C',1);
    $pdf->Cell(40,10,$Proveedores[$i]['nombre_p'],1,0,'C',1);
	$pdf->SetFont('Arial','',8);
    $pdf->Cell(60,10,$Proveedores[$i]['direccion_p'],1,0,'C',1);
    $pdf->Cell(30,10,$Proveedores[$i]['telefono_p'],1,0,'C',1);
    $pdf->Cell(45,10,$Proveedores[$i]['correo_p'],1,0,'C',1);
	$pdf->Ln(10);
}


$pdf->Output('I','Proveedores'.'.pdf');  // envia el documento
?>