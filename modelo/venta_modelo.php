<?php
	...
	class ventaModelo extends Conexion {
		...
		public function incluir() { // funcion para Incluir
			$registro = "INSERT INTO venta (documento_cliente,cantidad_prendas,id_pedidoU,precio_unitario,descripcion,descuento,fecha_venta) VALUES (:documentocliente,:cantidadprendas,:idpedidoU,:preciounitario,:descrip,:descuen,:fechaventa)";
			$preparado = $this->objbd->prepare($registro);
			...
			$preparado->bindParam(':fechaventa', $this->fechaventa);
			$resul= $preparado->execute();
