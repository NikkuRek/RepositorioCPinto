...
<html>
    ...
    <div class="px-6 py-4">
            ...
            <a href="#" class="btn btn-blanco">   
                    <span class="texto-superior">Pedido</span><?php echo $pedidou['id_pedidoU']; ?>
                                    <?php echo $pedidou['nombre']; ?>
                                    <?php echo $pedidou['fecha_final']; ?>
                                    <input type="submit" value="Ver_pedido" name="verpedido" class="btn btn-info">
                                    <a href="transacciones_controlador.php?id=<?php echo $pedidou['id_pedidoU'] ?>" class="btn btn-info">
            </a>
            <?php } ?>
           ...
           <a href="../controlador/salidaForm_controlador.php" class="btn btn-blanco">
                <!--<img src="../vista/img/tablon.png" alt="Agregar Salida">-->
                    <div class="texto-contenedor">
                      <span class="texto-superior">Pedido </span>
                      <span class="texto-superior">Cliente</span>
                      <span class="texto-superior">fecha Limite: </span>
                      <span class="texto-superior">fecha</span>
                      <input type="submit" value="Ver_pedido" name="verpedido" class="btn btn-info">
                     </div>
            </a> 
                </div> 
                    ...
                    <table class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <?php foreach ($lista_pedidou as $pedidou){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="transacciones_controlador.php?id=<?php echo $pedidou['id_pedidoU'] ?>" class="btn btn-azul modal_abrir_modificar">
                                    <img src="../vista/img/pencil.png" alt="Modificar" width="16" height="16"></a>
                                  <a href="../controlador/transacciones_controlador.php?eliminarId=<?php echo $pedidou['id_pedidoU'] ?>" class="btn btn-rojo">
