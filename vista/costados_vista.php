            ...
            <div class="contenedor-entrada1 px-6 pt-5">
                <div class="caja_scroll">
                    <table class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <?php foreach ($lista_costados as $costados) { ?>
                            <tr>
                                <td><?php echo $costados['id_costados']; ?></td>
                                <td><?php echo $costados['tipo_costados']; ?></td>
                                <td>
                                    <a href="costados_controlador.php?id=<?php echo $costados['id_costados'] ?>" class="btn btn-azul">
                                        <img src="../vista/img/pencil.png" alt="Modificar" width="16" height="16"></a>
                                    <a href="../controlador/costados_controlador.php?eliminarId=<?php echo $costados['id_costados'] ?>" class="btn btn-rojo">
                ...
                <?php if (isset($_GET['id'])) { ?>
                    <h1 class="display-6"><b>Datos de Costado </b></h1>
                <?php } else { ?>
                ...
                <form action="" method="POST">
                    <div id="f1" class="row col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="tipocostados" name="tipocostados" value="<?php echo $tipocostados; ?>" class="form-control form-control-sm">
                        </div>
