            ...
            <div class="contenedor-entrada1 px-6 pt-5">
                <div class="caja_scroll">
                    <table class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <?php foreach ($lista_cuello as $cuello) { ?>
                            <tr>
                                <td><?php echo $cuello['id_cuello']; ?></td>
                                <td><?php echo $cuello['tipo_cuello']; ?></td>
                                <td>
                                    <a href="cuello_controlador.php?id=<?php echo $cuello['id_cuello'] ?>" class="btn btn-azul">
                                        <img src="../vista/img/pencil.png" alt="Modificar" width="16" height="16"></a>
                                    <a href="../controlador/cuello_controlador.php?eliminarId=<?php echo $cuello['id_cuello'] ?>" class="btn btn-rojo">
                ...
                <?php if (isset($_GET['id'])) { ?>
                    <h1 class="display-6"><b>Datos de Cuello </b></h1>
                <?php } else { ?>
                    <h1 class="display-6"><b>Agregar Tipo de Cuello</b></h1>
                <?php } ?>
                <form action="" method="POST">
                    <div id="f1" class="row col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="idcuello" name="idcuello" value="<?php echo $idcuello; ?>" class="form-control form-control-sm">
                        </div>
                        <div class="col-md-12">
                            <label for=area>Tipo: </label>
                            <input type="text" id="tipocuello" name="tipocuello" value="<?php echo $tipocuello; ?>" class="form-control form-control-sm">
                        </div>
