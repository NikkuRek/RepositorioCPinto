...
<html>
                    ...
                    <table class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <?php foreach ($lista_venta as $venta){ ?>
                            <tr>
                                ...
                                <td>
                                  <a href="../controlador/proveedor_controlador.php?id=<?php echo $venta['id_venta'] ?>" class="btn btn-azul modal_abrir">
                                     <img src="../vista/img/pencil.png" alt="Modificar" width="16" height="16"></a>
                                  <a href="../controlador/proveedor_controlador.php?eliminarId=<?php echo $venta['id_venta'] ?>" class="btn btn-rojo">
    ...
    <div class="px-6 py-4">
                ...
                <!--id_venta=idproveedor	id_pedidoU=telefonop	documento_cliente=nombrep	cantidad_prendas=direccionp	precio_unitario=correop	descripcion	descuento	fecha_venta	
                    precio_unitario -->
